...
<main
	class="mx-auto flex h-[85dvh] flex-col items-start justify-center gap-4 p-10 sm:px-20 md:mx-20"
>
	<section
		class="mx-10 flex flex-col gap-4 text-justify
		text-base
		leading-relaxed
		md:text-lg
		lg:mx-20
	...
	>
		...
		<div class="h-[70dvh] overflow-y-scroll pr-5">
			<div class="mb-2">
				<Card.Root>
					<Card.Header>
						<Card.Title>Personal Banking Dashboard</Card.Title>
					</Card.Header>
					<Card.Content>
